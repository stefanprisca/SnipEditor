...
public class SnipDSLSemanticSequencer extends XbaseSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == SnipDSLPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case SnipDSLPackage.ATTRIBUTE:
				if(context == grammarAccess.getAbstractElementRule() ||
				   ...
				   context == grammarAccess.getBlockFeatureRule() ||
			...
			case SnipDSLPackage.MY_BLOCK_EXPRESSION:
				if(context == grammarAccess.getXExpressionInsideBlockRule() ||
				   context == grammarAccess.getMyBlockExpressionRule()) {
					sequence_myBlockExpression(context, (myBlockExpression) semanticObject); 
					return; 
				}
				else break;
			case SnipDSLPackage.PACKAGE_DECLARE:
				if(context == grammarAccess.getAbstractElementRule() ||
				   context == grammarAccess.getPackageDeclareRule()) {
	...
	/**
	 * Constraint:
	 *     (visible=Visibility? jType=JvmTypeReference name=myID value=XAssignment?)
	 */
	...
	/**
	 * Constraint:
	 *     (visibility=Visibility? name=ValidID superType=JvmTypeReference? features+=feature*)
	 */
	...
	/**
	 * Constraint:
	 *     (name=QualifiedNameWithWildcard | name=QualifiedName)
	 */
	...
	/**
	 * Constraint:
	 *     (visibility=Visibility? jType=JvmTypeReference name=ValidID (params+=parameter params+=parameter*)? body=XExpressionInsideBlock)
	 */
	 ...
	 */
	protected void sequence_myBlockExpression(EObject context, myBlockExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_parameter(EObject context, parameter semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, SnipDSLPackage.Literals.PARAMETER__PARAMETER_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SnipDSLPackage.Literals.PARAMETER__PARAMETER_TYPE));
			if(transientValues.isValueTransient(semanticObject, SnipDSLPackage.Literals.PARAMETER__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SnipDSLPackage.Literals.PARAMETER__NAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getParameterAccess().getParameterTypeJvmTypeReferenceParserRuleCall_0_0(), semanticObject.getParameterType());
