...
package org.eclipse.recommenders.snipeditor.ui.views;
...
import org.eclipse.recommenders.snipeditor.ui.editors.SnipEditorFileInput;
...
import org.eclipse.recommenders.snipeditor.ui.core.SummaryFileMap;
...
public class SnippetsView extends ViewPart {
    ...
    private void createSnippetsListComposite(final Composite parent) {
        ...
        snippetsList.addDoubleClickListener(new IDoubleClickListener() {
            ...
            public void doubleClick(DoubleClickEvent event) {
                ...
                SummaryFileMap map = snippetsMap.get(snippetsList.getList()
                        .getSelection()[0]);
    ...
    private void loadSnippetsList() {
        ...
        if (indexFile.exists()) {
            ...
            java.util.List<SummaryFileMap> sfMapList = GsonUtil.deserialize(
                    indexFile, listType);
    ...
    private String getSummarylabel(SummaryFileMap element) {
        ...
        String summary = summaryArray.length > 0 ? summaryArray[0]
                : element.summary;
        return summary;
    }
}
