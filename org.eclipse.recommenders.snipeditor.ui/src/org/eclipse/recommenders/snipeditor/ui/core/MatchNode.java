...
/**
 * Represents one node in a match tree structure. Can be either an effect call
 * (EffectMatchNode) or an argument (ArgumentMatchNode). Effect calls can be
 * nested into other effect calls.
 */
