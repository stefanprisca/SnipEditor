...
/**
 * This class represents one snippet. A match can contain many snippets in a
 * nested structure. Nesting is no longer used in the current version of
 * SnipMatch. SnipMatch can theoretically support effects that are not snippets.
 * For example, an effect could be a set of instructions to be executed in some
 * program. However, since this library is only being used for the Eclipse
 * plugin, an effect is essentially a snippet.
 */
public class Effect {
     ...
     * @return The search parameter with the given name. Returns null if no such
     *         parameter exists.
     */
    ...
    /**
     * Returns the full type string for this effect, which is just
     * <majorType>:<minorType>
     * 
