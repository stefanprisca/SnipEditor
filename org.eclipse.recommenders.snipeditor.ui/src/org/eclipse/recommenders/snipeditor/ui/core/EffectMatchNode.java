...
public class EffectMatchNode extends MatchNode {
    ...
    public MatchNode clone() {
        ...
        EffectMatchNode clone = new EffectMatchNode(effect, pattern,
                childClones);
    ...
    /**
     * Gets whether or not this effect node is complete (all arguments are
     * non-empty).
     * 
     * @return
     */
