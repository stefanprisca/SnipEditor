...
* generated by Xtext
*/
package org.eclipse.recommenders.snipeditor.ui.contentassist.antlr;
...
public class SnipDSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.recommenders.snipeditor.ui.contentassist.antlr.internal.InternalSnipDSLParser createParser() {
		org.eclipse.recommenders.snipeditor.ui.contentassist.antlr.internal.InternalSnipDSLParser result = new org.eclipse.recommenders.snipeditor.ui.contentassist.antlr.internal.InternalSnipDSLParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getImportDeclareAccess().getNameAlternatives_1_0(), "rule__ImportDeclare__NameAlternatives_1_0");
					...
					put(grammarAccess.getPackageDeclareAccess().getElementsAssignment_3(), "rule__PackageDeclare__ElementsAssignment_3");
					...
					put(grammarAccess.getMethodAccess().getJTypeAssignment_2(), "rule__Method__JTypeAssignment_2");
					...
					put(grammarAccess.getAttributeAccess().getVisibleAssignment_0(), "rule__Attribute__VisibleAssignment_0");
					put(grammarAccess.getAttributeAccess().getJTypeAssignment_2(), "rule__Attribute__JTypeAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.recommenders.snipeditor.ui.contentassist.antlr.internal.InternalSnipDSLParser typedParser = (org.eclipse.recommenders.snipeditor.ui.contentassist.antlr.internal.InternalSnipDSLParser) parser;
