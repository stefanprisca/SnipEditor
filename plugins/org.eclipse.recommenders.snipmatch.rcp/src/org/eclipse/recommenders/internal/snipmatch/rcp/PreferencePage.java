...
public class PreferencePage extends FieldEditorPreferencePage implements
    ...
    public void createFieldEditors() {
        snippetsRepoField = new StringButtonFieldEditor(P_SNIPPETS_REPO,
                "&Remote Snippets Repository:", getFieldEditorParent()) {

            @Override
            protected String changePressed() {
                String url = getPreferenceStore().getDefaultString(
                        P_SNIPPETS_REPO);

                InputDialog d = new InputDialog(getShell(),
                        "New Snippet Repository",
                        "Enter snippet repository URL:", url,
    ...
    public void init(IWorkbench workbench) {
        ScopedPreferenceStore store = new ScopedPreferenceStore(
                InstanceScope.INSTANCE, Constants.BUNDLE_ID);
